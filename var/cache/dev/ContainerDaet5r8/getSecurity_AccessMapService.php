...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/inkoper/*'), array(0 => 'ROLE_INKOPER'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/magazijnmeester/*'), array(0 => 'ROLE_MAGAZIJNMEESTER'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/administrator/*'), array(0 => 'ROLE_ADMINISTRATOR'), NULL);
