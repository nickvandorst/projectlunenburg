...
class __TwigTemplate_1b67e2a204c14087cb25ace45fde05ab6e68cee1dfb131a68ab35d6a136fb2a5 extends Twig_Template
{
        ...
        <table class=\"decision-log\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["decision"]) {
                ...
                if ((twig_length_filter($this->env, $this->getAttribute($context["decision"], "attributes", array())) == 1)) {
                    // line 320
                    echo "                                ";
                    $context["attribute"] = twig_first($this->env, $this->getAttribute($context["decision"], "attributes", array()));
                    // line 321
                    echo "                                ";
                    if ($this->getAttribute(($context["attribute"] ?? null), "expression", array(), "any", true, true)) {
                        // line 322
                        echo "                                    Expression: <pre><code>";
                        echo twig_escape_filter($this->env, $this->getAttribute(($context["attribute"] ?? $this->getContext($context, "attribute")), "expression", array()), "html", null, true);
                        echo "</code></pre>
                                ";
                    } elseif (($this->getAttribute(                    // line 323
($context["attribute"] ?? $this->getContext($context, "attribute")), "type", array()) == "string")) {
                        // line 324
                        echo "                                    ";
                        ...
                        // line 326
                        echo "                                     ";
                        echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), array($this->env, ($context["attribute"] ?? $this->getContext($context, "attribute"))));
                        echo "
                                ";
                    }
                    // line 328
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "C:\\xampp\\htdocs\\vmslunenburg\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle\\Resources\\views\\Collector\\security.html.twig");
    }
}
